      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href="mailto:vk82088@gmail.com" className="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors">
                <Mail className="h-5 w-5" />
                <span>vk82088@gmail.com</span>
              </a>
              <a href="tel:+917891374770" className="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors">
                <Phone className="h-5 w-5" />
                <span>+91 78913 74770</span>
              </a>
            </div>
          </div>
        </div>
