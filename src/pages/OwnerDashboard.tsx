                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="mt-2 grid grid-cols-2 sm:grid-cols-3 gap-4">
                      ...
                      <div>
                        <p className="text-sm text-gray-600">{t.rentPerMonth}</p>
                        <p className="font-semibold text-blue-600">
                          {t.currencySymbol}{parseFloat(listing.rentPerMonth || '0').toLocaleString('en-IN')}/month
                        </p>
                      </div>
                      <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md w-full"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700">
                        {t.rentPerMonth} ({t.currencySymbol})
                      </label>
                      <input
                        type="number"
                        value={editingListing.rentPerMonth}
                        onChange={e => setEditingListing({...editingListing, rentPerMonth: e.target.value})}
                        className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md w-full"
                      />
                    </div>
                  </div>
